...
def index(request):
    ...
    most_populars_posts_ids = [post.id for post in most_popular_posts]
    fresh_posts = all_posts.order_by('published_at')
    most_fresh_posts = list(fresh_posts)[-5:]
    most_fresh_posts_ids = [post.id for post in most_fresh_posts]
    all_useful_posts_ids = set(chain(most_populars_posts_ids, most_fresh_posts_ids))
    posts_with_comments = Post.objects.filter(id__in=all_useful_posts_ids) \
