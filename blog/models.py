...
class PostQuerySet(models.QuerySet):
    ...
    def popular(self):
        popular_posts = self.fetch_likes_count().order_by('-likes_count')
        return popular_posts

    def fetch_with_comments(self):
        most_populars_posts_ids = [post.id for post in self]
        posts_with_comments = Post.objects.filter(id__in=most_populars_posts_ids) \
...
class TagQuerySet(models.QuerySet):
    ...
    def popular(self):
        popular_tags = self.fetch_posts_count().order_by('-posts_count')
        return popular_tags
